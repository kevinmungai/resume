...
\usepackage[top=1cm,left=1cm,right=0cm,bottom=0cm]{geometry}
...
\begin{tabular}{l l}
\raisebox{-.3\height}{\includegraphics[scale=0.04]{photo}} & {\fontsize{26}{48}\selectfont \textbf{Kevin Mungai}}\\  
\end{tabular}\\[1cm]
...
% \includegraphics [scale=0.04] {photo}
% \hspace{1cm}
% {\fontsize{26}{48}\selectfont \textbf{Kevin Mungai}}
